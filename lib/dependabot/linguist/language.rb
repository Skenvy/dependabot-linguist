...
# https://github.com/github/linguist/blob/v7.30.0/lib/linguist/vendor.yml
...
module Linguist
  # https://github.com/github/linguist/blob/v7.30.0/lib/linguist/language.rb
  ...
  module BlobHelper
    # https://github.com/github/linguist/blob/v7.30.0/lib/linguist/blob_helper.rb#L220
