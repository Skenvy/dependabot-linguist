...
# rubocop:disable Layout/HashAlignment, Lint/ConstantDefinitionInBlock
...
RSpec.describe ::Dependabot::Linguist::Repository do
  ...
  TEST_CONFIG.each do |file_fetcher, test_configs| # rubocop:disable Metrics/BlockLength
    test_configs.each do |test_config| # rubocop:disable Metrics/BlockLength
...
# rubocop:enable Layout/HashAlignment, Lint/ConstantDefinitionInBlock
